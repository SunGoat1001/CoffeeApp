<div>
    <!-- Generate API Token -->
    <x-panel :header="__('Create API Token')" :sub-header="__('API tokens allow third-party services to authenticate with our application on your behalf.')">
    ...
    @if (auth()->user()->tokens->isNotEmpty())
        <!-- Manage API Tokens -->
        <div class="mt-10">
            <x-panel :header="__('Manage API Tokens')" :sub-header="__('You may delete any of your existing tokens if they are no longer needed.')">
                <!-- API Token List -->
                <div class="space-y-6">
    ...
    <x-dialog-modal name="displaying-token" focusable>
        ...
        <x-slot name="content">
            ...
            <x-text-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken" class="mt-4 w-full break-all"
